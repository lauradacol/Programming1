...
public class AddEspFrame extends javax.swing.JInternalFrame {
    ...
    private void btSelectActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btSelectActionPerformed
        ...
        addEspTextField.setText(especie);
    ...
    private void btUpdateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btUpdateActionPerformed
        ...
        Especie e1 = EspecieFactory.getInstance().findEsp(familia, genero,especie);

        String famNova = addFamTextField.getText();
        String genNovo = addGenTextField.getText();
        String espNova = addEspTextField.getText();
        
        EspecieFactory.getInstance().updateEsp(e1, famNova, genNovo, espNova);
        initEspTable();
