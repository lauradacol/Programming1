 ...
 * O objetivo é permitir o cadastro, busca e atualização dos dados de indivíduos 
 * tombados na coleção. Os dados relacionam-se da seguinte forma:
 ...
 * - A Localidade possui dados: Unidade Federativa (UF), Município e Localidade). 
 * Exemplo: SC, Chapecó, UFFS. SC, Chapecó, Ecoparque.
 * - O coletor possui os dados: Nome, email e telefone. 
 * - Indivíduos ainda possuiem os atributos data (data em que foi coletado), 
 * recipiente (recipiente na coleção física em que este animal encontra-se, por 
 * exemplo "Estante 1, Vidro 6") e observações.
 *
 * É possível cadastrar no sistema familia, genero, especie, localidade e 
 * coletor separadamente ou no momento de tombar um indivíduo. 
 * 
 * 
 * 
 */
